...
def test_post(rh, creatable_association):
    ...
    rh.assert_response(rh.open('delete', f'{api}/media/{a.media_id}/perm/{a.perm_name}'), 200, headers={RECORD_COUNT_HEADER: '1'})
    rh.assert_response(rh.open('delete', f'{api}/media/{a.media_id}/perm/{a.perm_name}'), 200, headers={RECORD_COUNT_HEADER: '0'})
